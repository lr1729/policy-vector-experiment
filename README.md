# Policy Vector Pipeline (Shareable Bundle)

This bundle contains the code, prompts, and reference artifacts needed to:
...
- `thought-anchors.txt` – reference notes cited in project docs.
- `requirements.txt` – consolidated dependencies.
- `PROGRESS.md` – short history of major changes.
